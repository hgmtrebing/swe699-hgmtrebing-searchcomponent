...
public enum State {
    ...
    public static State parseFromString (String stateString) {

        for (State state : State.values()) {
            if (state.getAbbreviation().equalsIgnoreCase(stateString) || state.getName().equalsIgnoreCase(stateString)) {
                return state;
            }
        }
